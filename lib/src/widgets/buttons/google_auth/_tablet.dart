...
class GoogleAuthButtonTablet extends StatefulWidget {
  ...
  @override
  State<GoogleAuthButtonTablet> createState() => _GoogleAuthButtonTabletState();
}

class _GoogleAuthButtonTabletState extends State<GoogleAuthButtonTablet> {
  bool _pressed = false;
