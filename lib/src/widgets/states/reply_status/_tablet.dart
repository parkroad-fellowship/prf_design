...
/// Tablet layout for ReplyStatusView. Internal — prefer the parent widget.
class PRFReplyStatusTablet extends StatefulWidget {
  const PRFReplyStatusTablet({
  ...
  @override
  State<PRFReplyStatusTablet> createState() => _PRFReplyStatusTabletState();
}

class _PRFReplyStatusTabletState extends State<PRFReplyStatusTablet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      // tablet: wider outer padding for breathing room
        ...
        child: Row(
          children: [
            for (int i = 0; i < chips.length; i++) ...[
              if (i > 0) const SizedBox(width: PRFSpacingTokens.md),
